...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item{Zuul, nodepool and gerrit event streams}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item{Make unusual log lines emerge}
    \end{itemize}
    \begin{itemize}
        \item{Help identitify new elastich recheck signatures}
...
\begin{frame}
    ...
    \begin{itemize}
        \item{https://github.com/sherjilozair/char-rnn-tensorflow}
    \end{itemize}
\end{frame}
